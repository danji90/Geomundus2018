	...
	$.elastislide.prototype 	= {
		...
		_setDim				: function( elW ) {
			...
			this.$items.css({
				...
				//alaa add 30 to the image width for bigger thumbnails
				width		: ( elW ) ? elW : (this.options.imageW + 30) + 2 * this.options.border
		...
		_setCurrentValues	: function() {
			...
			//alaa add 10 to the itemW to eliminate the second row  of the slider
			this.itemW			= this.$items.outerWidth(true) + 10;
		...
		_slideToCurrent		: function( anim ) {
			...
			// how much to slide?
			//alaa fix the sliding when clicking a photo, remove 10 from the item size
			var amount	= this.current * (this.itemW - 10);
